...
hi Identifier	term=underline		ctermfg=White						guifg=Cyan
hi Operator	term=underline		ctermfg=White						guifg=Cyan
hi Character	term=underline		ctermfg=White						guifg=Cyan
...
hi Statement	term=bold		ctermfg=White				gui=NONE	guifg=Yellow
